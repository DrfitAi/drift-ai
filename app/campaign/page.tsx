            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {[
                ...
                },
                {
                  ...
                  description: "Address pain → show case → ask. Works well for exec roles."
                },
                {
                  id: "linkedin",
                  title: "LinkedIn Invite + Drop",
                  description: "Friendly invite → soft drop → follow-up. Great for founders."
                },
                {
                  id: "quickwin",
                  title: "Quick Win Sequence",
                  description: "Give value fast → follow-up → re-engage. Reciprocity-driven."
                },
                {
                  id: "punch",
                  title: "Punch + Case",
                  description: "Challenge assumption → share result → nudge. For tough leads."
                }
              ].map(flow => (
                <div
                  key={flow.id}
        ...
        {step === 4 && (
          <section className="space-y-10 animate-fade-in">
            ...
            <div className="text-center pt-8">
              ...
              <p className="text-sm text-zinc-500 mt-2">Create account to activate your agent</p>
            </div>
          </section>
        )}
      </div>
